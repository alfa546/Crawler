...
LABEL="io.crawler.app"
UPDATE_LABEL="io.crawler.update"
PLIST_DIR="$HOME/Library/LaunchAgents"
APP_PLIST="$PLIST_DIR/${LABEL}.plist"
UPDATE_PLIST="$PLIST_DIR/${UPDATE_LABEL}.plist"
LOG_DIR="$HOME/Library/Logs/Crawler"
PORT=5002
MIN_PY_MAJOR=3
MIN_PY_MINOR=10
MIN_DISK_MB=500
...
# ---------- Preflight ----------
echo "=============================================="
echo " Crawler — macOS preflight checks"
...
#!/usr/bin/env bash
# Auto-updater for Crawler (macOS).
